...
class AppRoutes {
  ...
  static Page _homeScreenBuilder(BuildContext context, GoRouterState state) {
    ...
    if (state.extra != null && state.extra is User) {
      ...
      user = User(
        id: 002,
        name: "Wina Senja Maulina",
        username: "Wina Senja Maulina",
        email: "2006196@gmail.com",
        profilePhoto:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4eCw49v7AsIZYIqSPA7HgWrJB9pnIch0KNHVMn7uV9g&s",
        phoneNumber: "089516044153",
      );
    }
    return MaterialPage(
      child: HomeScreen(
